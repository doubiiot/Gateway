...
# Generated by qmake (2.01a) (Qt 4.5.0) on: ?? 7? 24 13:46:31 2017
# Project:  GateWay.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		ultra.cpp \
		newDlg.cpp \
		Dlg_humi.cpp moc_mainwindow.cpp \
...
$(TARGET): ui_mainwindow.h ui_newdlg.h ui_dlg_humi.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents mainwindow.h posix_qextserialport.h qextserialbase.h socketservice.h serialservice.h temp_humi_light.h motor.h relays.h infray.h pwm.h enddevice.h ultra.h shake.h smoke.h touch.h newDlg.h Dlg_humi.h .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp posix_qextserialport.cpp qextserialbase.cpp socketservice.cpp serialservice.cpp temp_humi_light.cpp motor.cpp relays.cpp infray.cpp pwm.cpp enddevice.cpp shake.cpp smoke.cpp touch.cpp ultra.cpp newDlg.cpp Dlg_humi.cpp .tmp/GateWay1.0.0/ && $(COPY_FILE) --parents mainwindow.ui newdlg.ui dlg_humi.ui .tmp/GateWay1.0.0/ && (cd `dirname .tmp/GateWay1.0.0` && $(TAR) GateWay1.0.0.tar GateWay1.0.0 && $(COMPRESS) GateWay1.0.0.tar) && $(MOVE) `dirname .tmp/GateWay1.0.0`/GateWay1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/GateWay1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_qextserialbase.cpp moc_socketservice.cpp moc_serialservice.cpp moc_enddevice.cpp moc_newDlg.cpp moc_Dlg_humi.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_qextserialbase.cpp moc_socketservice.cpp moc_serialservice.cpp moc_enddevice.cpp moc_newDlg.cpp moc_Dlg_humi.cpp
...
moc_socketservice.cpp: serialservice.h \
		posix_qextserialport.h \
		qextserialbase.h \
		temp_humi_light.h \
		enddevice.h \
...
moc_newDlg.cpp: newDlg.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) newDlg.h -o moc_newDlg.cpp

moc_Dlg_humi.cpp: Dlg_humi.h
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/moc $(DEFINES) $(INCPATH) Dlg_humi.h -o moc_Dlg_humi.cpp
...
compiler_uic_make_all: ui_mainwindow.h ui_newdlg.h ui_dlg_humi.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_newdlg.h ui_dlg_humi.h
ui_mainwindow.h: mainwindow.ui
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/uic mainwindow.ui -o ui_mainwindow.h

ui_newdlg.h: newdlg.ui
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/uic newdlg.ui -o ui_newdlg.h

ui_dlg_humi.h: dlg_humi.ui
	/usr/local/Trolltech/QtEmbedded-4.5.0-arm-embedded/bin/uic dlg_humi.ui -o ui_dlg_humi.h
...
newDlg.o: newDlg.cpp newDlg.h \
		ui_newdlg.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o newDlg.o newDlg.cpp

Dlg_humi.o: Dlg_humi.cpp Dlg_humi.h \
		ui_dlg_humi.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Dlg_humi.o Dlg_humi.cpp
...
moc_newDlg.o: moc_newDlg.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_newDlg.o moc_newDlg.cpp

moc_Dlg_humi.o: moc_Dlg_humi.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Dlg_humi.o moc_Dlg_humi.cpp
